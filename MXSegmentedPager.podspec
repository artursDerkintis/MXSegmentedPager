...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       MXSegmentedPager combines [MXPagerView](https://github.com/maxep/MXPagerView) with [HMSegmentedControl](https://github.com/artursDerkintis/HMSegmentedControl) to control the page selection.
  ...
  s.source           = { :git => "https://github.com/artursDerkintis/MXSegmentedPager.git", :tag => s.version.to_s }
  ...
  s.dependency 'HMSegmentedControl', '~> 1.5.3', :git => "https://github.com/artursDerkintis/HMSegmentedControl.git"
